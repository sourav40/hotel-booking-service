package edu.miu.cs590.bookingservice.config;

import edu.miu.cs590.bookingservice.dto.ErrorResponse;
...
//    }
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        return new ResponseEntity<>(new ErrorResponse(HttpStatus.BAD_REQUEST,errors.toString(), request.getDescription(false)),HttpStatus.BAD_REQUEST);
    }
}
